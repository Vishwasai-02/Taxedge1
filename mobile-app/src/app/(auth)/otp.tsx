  ...
  const handleCreateProfile = () => {
    ...
    setTimeout(() => {
      ...
      register({
        ...
        pan: profileData.pan.trim().toUpperCase(),
      ...
      >
        ...
        <View style={styles.headerSection}>
          ...
          <Text style={[styles.subTitle, { color: "#64748B" }]}>
            Enter the 6-digit OTP sent to +91 {mobileNumber || "9048764876"}
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  headerSection: {
    alignItems: "center",
    marginBottom: 32,
    marginTop: 80, // Moved down a bit to clear the back button better
  },
  title: {
    fontSize: 22,
    fontWeight: "700",
  ...
  verifyBtn: {
    ...
    borderRadius: 12,
    elevation: 0,
    shadowOpacity: 0, // No shadow needed for verifyBtn according to image
  },
  resendContainer: {
    marginTop: 20,
    alignItems: "center",
